...
- **Plazo para la consecución** — **5 velas — es un TOPE, no una espera obligatoria *(`R-14`, precisada 01/09/2026)*** desde la siguiente a la que rompió. Lo normal es la primera o la segunda
...
- **Plazo para que aparezca** — **Ninguno.** El límite de 5 velas — es un TOPE, no una espera obligatoria *(`R-14`, precisada 01/09/2026)* no aplica aquí
...
| Plazo | 5 velas — es un TOPE, no una espera obligatoria *(`R-14`, precisada 01/09/2026)* para la consecución | Sin plazo para aparecer; inmediato para entrar |
