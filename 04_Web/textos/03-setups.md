...
> 🖼 **Gráfico.** Texto alternativo: Lámina del setup IRI: un impulso deja la zona, el precio retrocede y el segundo impulso la rompe; la entrada va en la vela que confirma
...
### IRI (Impulso - Retroceso - Impulso) R-25

#### El concepto fundamental

El IRI (Impulso - Retroceso - Impulso) es un modelo de entrada autocontenido. Significa que no necesitas buscar referencias del pasado ni indicadores externos: el propio movimiento del precio crea en tiempo real la zona que va a romper.
...
3. **La zona.** Se marca el nivel exacto en la vela extrema que dejó la corrida antes de empezar a retroceder. **Sin zona marcada en la vela extrema, no existe el IRI.**
...
El IRI solo se opera si la corrida que lo arma es **fluida**. La secuencia tiene que salir bien tres veces seguidas; si falla una, ese rompimiento no se opera.
...
3. **La corrida siguiente rompe esa zona.** Ese es el rompimiento que opera el IRI.
...
- **A qué setup afecta** — Solo al IRI. El Reingreso no se toca
