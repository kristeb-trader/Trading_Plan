...
**Versión:** 3.1 — 🏁 **FASE 1 CERRADA · numeración nueva · documento reorganizado por categorías**
...
| **R-10 · Extensión** | Rompimiento **con mecha** + 5 velas sin consecución → la zona original **crece** hasta la punta de esa mecha. Queda **una** zona | ✅ |
| **R-11 · Zona apéndice** | Rompimiento **con cuerpo** + 5 velas sin consecución → nace una **zona nueva** sobre la mecha de la vela de rompimiento. La original no se toca. Quedan **dos** zonas | ✅ |
